...
joint (tableC block_1) { from=<T .15 .3 .07 0.707107 0 0 -0.707107 > type=10 } # from=<T .1 .3 .07 0.707107 0 0 0.707107 >
joint (tableC block_2) { from=<T -.15 .3 .07 0.707107 0 0 -0.707107 > type=10 } # from=<T -.1 .3 .07 0.707107 0 0 0.707107 >
...
{
 shape id_1(block_2) { type=9 rel=<T t(0.05 0 0.0)> size=[.02 .1 .1 .01] color=[0 1 0] }
 shape id_2(block_1) { type=9 rel=<T t(0.05 0 0.0)> size=[.02 .1 .1 .01] color=[1 0 0] }
}
}
